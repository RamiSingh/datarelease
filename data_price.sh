...
##############################
# let's find a way for the user to provide some way of input to distinguish between the role of this script.
...
# get the locations saved in the form of variables:
# For INT1 AU
